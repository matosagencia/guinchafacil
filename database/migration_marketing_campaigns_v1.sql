-- Camada de orquestração do marketing territorial. Não duplica zonas,
-- demanda, UTMs, usuários ou gastos: apenas relaciona essas fontes.
CREATE TABLE IF NOT EXISTS marketing_campaigns (
    ...
    PRIMARY KEY (id),
    KEY idx_marketing_campaigns_zone (pricing_zone_id),
...
CREATE TABLE IF NOT EXISTS marketing_campaign_events (
    ...
    created_at DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
    PRIMARY KEY (id),
    KEY idx_campaign_events_campaign_date (campaign_id, created_at),
    KEY idx_campaign_events_type_date (event_type, created_at),
