...
final class OficinaParceriaController extends BaseController
{
 ...
 public function admin():void{AuthService::requireAuth('admin');$indicacoes=PedidoIndicacaoOficina::listarPendentes();$oficinas=Provider::listarTodos();require __DIR__.'/../Views/admin/oficinas_parceiras.php';}
