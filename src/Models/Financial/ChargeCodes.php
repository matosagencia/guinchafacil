...
final class ChargeCodes
{
    ...
    public const PHASE_MOBILE_QUOTE_APPROVAL = 'MOBILE_QUOTE_APPROVAL';
    ...
    public const PHASES = [
        ...
        self::PHASE_MOBILE_QUOTE_APPROVAL,
    ];
    ...
    public const TYPE_MOBILE_QUOTE_APPROVED_FEE = 'MOBILE_QUOTE_APPROVED_FEE';
    ...
    public const CHARGE_TYPES = [
        ...
        self::TYPE_MOBILE_QUOTE_APPROVED_FEE,
    ];
