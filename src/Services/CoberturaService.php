...
class CoberturaService
{
    ...
    public static function diagnosticarAtendimento(array $pedido): array
    {
        ...
        return [
            ...
            'pode_especialista' => false,
            'pode_reboque' => false,
            'mensagem' => 'Recebemos sua localização e seguimos ampliando as alternativas de atendimento nessa região. Revise o endereço ou tente novamente em alguns instantes.',
            'service_code' => $serviceCode,
        ];
    }
