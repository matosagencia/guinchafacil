...
<head>
    ...
    <?php if (in_array($temaClass, ['guincho', 'especialista'], true)): ?>
    <link rel="manifest" href="<?php echo htmlspecialchars($bp); ?>/public/manifest.json">
    ...
    <?php if (in_array($temaClass, ['guincho', 'especialista'], true)): ?>
    <script<?php echo csp_script_nonce_attr(); ?> defer src="<?php echo htmlspecialchars($bp); ?>/public/assets/js/push-notifications.js"></script>
    <?php endif; ?>
    <?php if ($temaClass === 'admin'): ?>
