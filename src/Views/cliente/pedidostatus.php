...
<main class="main-content">
    ...
    <?php if (!empty($decisaoReboquePendente)): ?>
    <div class="card border-primary mb-4">
        <div class="card-header bg-primary-subtle"><i class="fas fa-route me-2"></i>Próxima decisão</div>
        <div class="card-body">
            <p class="mb-3">O orçamento foi aprovado. Você precisa rebocar o veículo?</p>
            <div class="d-flex gap-2 flex-wrap">
                <form method="post" action="<?php echo $bp; ?>/cliente/pedido/reboque/decidir/<?php echo $pedidoId; ?>">
                    <input type="hidden" name="csrf_token" value="<?php echo htmlspecialchars($csrfToken); ?>">
                    <input type="hidden" name="decisao" value="nao">
                    <button type="submit" class="btn btn-success"><i class="fas fa-check me-1"></i>Não, finalizar atendimento</button>
                </form>
                <form method="post" action="<?php echo $bp; ?>/cliente/pedido/reboque/decidir/<?php echo $pedidoId; ?>">
                    <input type="hidden" name="csrf_token" value="<?php echo htmlspecialchars($csrfToken); ?>">
                    <input type="hidden" name="decisao" value="sim">
                    <button type="submit" class="btn btn-outline-primary"><i class="fas fa-truck me-1"></i>Sim, cotar reboque</button>
                </form>
            </div>
        </div>
    </div>
