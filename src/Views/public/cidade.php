...
$titulo = "Guincho e Reboque 24h em {$nomeCidade}" . ($uf !== '' ? " - {$uf}" : '');
$descricao = "Peça guincho e reboque 24 horas em {$nomeCidade}. Conte o que aconteceu, veja a cotação e acompanhe a assistência veicular.";
...
$faq = [
    ['q' => "Como sei se existe cobertura em {$nomeCidade}?", 'a' => 'A página mostra as zonas com atendimento ativo e as áreas mapeadas para expansão. Ao solicitar, a triagem confirma se há prestador disponível para guincho ou reboque no ponto informado.'],
    ['q' => 'Consigo ver as condições antes de pagar?', 'a' => 'Sim. A cotação apresenta o valor e as condições do serviço de guincho ou reboque antes da confirmação do pagamento.'],
    ['q' => 'Quais formas de pagamento estão disponíveis?', 'a' => 'Conforme o gateway disponível no checkout, o pagamento pode ser feito por Pix, cartão ou boleto. As opções apresentadas na tela valem para aquela solicitação.'],
    ['q' => 'O atendimento pode ser solicitado 24 horas?', 'a' => 'Você pode solicitar assistência 24 horas para guincho ou reboque; a disponibilidade depende dos prestadores ativos na região e do tipo de atendimento.'],
];
