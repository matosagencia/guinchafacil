...
<body class="gf-landing"><header class="gf-nav"><a class="gf-brand" href="<?= $e($bp) ?>/"><img src="<?= $e($bp) ?>/public/assets/img/logo-48.png" alt="" width="40" height="40"><span>Guincha<strong>F&aacute;cil</strong></span></a><nav aria-label="Navega&ccedil;&atilde;o principal"><a href="#como-funciona">Como funciona</a><details class="gf-cities-menu"><summary>Cidades</summary><div class="gf-cities-dropdown"><span class="gf-cities-title">Atendimento por cidade</span><?php foreach (array_slice($cidadesSeo ?? [], 0, 20) as $cidadeSeo): ?><a href="<?= $e($bp) ?>/guincho/<?= $e((string)$cidadeSeo['slug']) ?>"><?= $e((string)$cidadeSeo['nome']) ?><?= !empty($cidadeSeo['uf']) ? ' - ' . $e(strtoupper((string)$cidadeSeo['uf'])) : '' ?></a><?php endforeach; ?><a class="gf-cities-all" href="<?= $e($bp) ?>/guincho">Ver todas as cidades</a></div></details><a href="#parceiros">Seja parceiro</a><a class="gf-login" href="<?= $e($bp) ?>/login">Entrar</a></nav></header>
