...
<body class="gf-landing"><header class="gf-nav"><a class="gf-brand" href="<?= $e($bp) ?>/"><img src="<?= $e($bp) ?>/public/assets/img/logo-48.png" alt="" width="40" height="40"><span>Guincha<strong>F&aacute;cil</strong></span></a><nav aria-label="Navega&ccedil;&atilde;o principal"><a href="#como-funciona">Como funciona</a><div class="gf-cities-menu"><a class="gf-cities-toggle" href="<?= $e($bp) ?>/guincho" aria-haspopup="true">Cidades</a><div class="gf-cities-dropdown"><span class="gf-cities-title">Atendimento por cidade</span><?php foreach (array_slice($cidadesSeo ?? [], 0, 20) as $cidadeSeo): ?><a href="<?= $e($bp) ?>/guincho/<?= $e((string)$cidadeSeo['slug']) ?>"><?= $e((string)$cidadeSeo['nome']) ?><?= !empty($cidadeSeo['uf']) ? ' - ' . $e(strtoupper((string)$cidadeSeo['uf'])) : '' ?></a><?php endforeach; ?><a class="gf-cities-all" href="<?= $e($bp) ?>/guincho">Ver todas as cidades</a></div></div><a href="#parceiros">Seja parceiro</a><a class="gf-login" href="<?= $e($bp) ?>/login">Entrar</a></nav></header>
...
<?php if (!empty($cidadesSeo)): ?><section class="gf-section" id="cidades-atendidas"><p class="gf-eyebrow">Atendimento local</p><h2>Guincho e assistencia por cidade</h2><p class="gf-muted">Encontre a pagina da sua cidade e veja as areas com atendimento ativo.</p><div class="gf-process"><?php foreach ($cidadesSeo as $cidadeSeo): ?><article><i>⌖</i><h3><a href="<?= $e($bp) ?>/guincho/<?= $e((string)$cidadeSeo['slug']) ?>"><?= $e((string)$cidadeSeo['nome']) ?><?= !empty($cidadeSeo['uf']) ? ' - ' . $e(strtoupper((string)$cidadeSeo['uf'])) : '' ?></a></h3><p>Guincho e assistencia veicular por zonas ativas.</p></article><?php endforeach; ?></div></section><?php endif; ?>
