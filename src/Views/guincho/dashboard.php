        ...
        <section class="card shadow-sm mb-4">
            <div class="card-body d-flex flex-wrap justify-content-between align-items-center gap-3">
                <div>
                    ...
                    <p class="text-muted mb-0">Ative para receber pedidos mesmo com a aba fechada ou em segundo plano.</p>
                </div>
                <div class="d-flex align-items-center gap-2">
                    <span class="badge text-bg-secondary" data-push-state>Inativo</span>
                    <button type="button" class="btn btn-outline-primary btn-sm" data-push-toggle <?php echo $pushPublicKey === '' ? 'title="Configure PUSH_VAPID_PUBLIC_KEY no .env"' : ''; ?>>
                        Ativar alertas
                    </button>
                </div>
            </div>
