...
<div class="reg-wrapper">
    ...
    <div class="reg-form-side">
        ...
        <div class="reg-form-body">
            ...
            <form method="POST" action="<?php echo $bp; ?>/registro/cliente" id="formCliente" novalidate>
                ...
                <div class="row g-3 mb-3">
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control" name="nome" placeholder="Seu nome" required minlength="3">
                    </div>
                    <div class="col-md-6">
                ...
                <p style="color:rgba(232,252,234,.3);font-size:.78rem;text-align:center">
                    ...
                    <a href="#" style="color:#2fb34a">Termos de Uso</a> e
                    <a href="#" style="color:#2fb34a">Política de Privacidade</a>.
                </p>
            </form>
...
document.getElementById('confirmar_senha').addEventListener('input', function() {
    ...
    document.getElementById('senhaFeedback').classList.toggle('d-none', ok || !this.value);
    this.classList.toggle('is-invalid', !ok && this.value !== '');
        ...
        fetch('https://viacep.com.br/ws/' + v.replace(/\D/g,'') + '/json/')
            .then(r => r.json()).then(d => {
                if (!d.erro) {
                    ...
                    status.innerHTML = '<i class="fas fa-check me-1" style="color:#2fb34a"></i>Endereço encontrado!';
                } else {
                    status.innerHTML = '<span style="color:#f87171">CEP não encontrado</span>';
                }
