...
<nav class="ops-nav" aria-label="Navegação administrativa">
    ...
    <div class="ops-nav-section">
        <button type="button" class="ops-nav-section__title ops-nav-section__toggle" data-section-id="servicos-e-planejamento" aria-expanded="true"><span class="ops-nav-section__title-text">Serviços e planejamento</span><i class="fas fa-chevron-down ops-nav-section__chevron" aria-hidden="true"></i></button>
        <div class="ops-nav-section__links">
...
(function () {
    ...
    // Tooltip nativo com o rótulo de cada link, usado quando o menu está recolhido.
    ...
    // Accordion por seção: cada bloco (Atendimento, Clientes, Financeiro...) pode
    // colapsar independentemente, preservando o estado por seção no localStorage.
