...
<nav class="ops-nav" aria-label="Navegação administrativa">
    ...
    <div class="ops-nav-section">
        ...
        <div class="ops-nav-section__links">
            ...
            <a href="<?php echo htmlspecialchars($bp); ?>/admin/configuracoes#ambiente" class="ops-nav-link <?php echo opsNavActive($cur, 'configuracoes'); ?>"><span class="ops-nav-link__icon"><i class="fas fa-shield-halved"></i></span><span class="ops-nav-link__label">Ambiente (.env)</span></a>
