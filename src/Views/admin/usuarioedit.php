                        ...
                        <div class="row g-3 mb-3">
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control" name="telegram_chat_id"
                                       value="<?php echo htmlspecialchars($usuario['telegram_chat_id'] ?? ''); ?>"
                                       placeholder="Ex.: 123456789 ou -1001234567890">
                                <small class="text-muted d-block mt-1">Usado no fallback gratuito da fase 3 quando o push não entregar.</small>
                            </div>
                        </div>
