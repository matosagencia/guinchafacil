...
<div class="shell-ops" id="especialistasShell">
  ...
  <section class="shell-ops-worklist">
    ...
    <?php else: foreach ($especialistas as $e): $aprovado=(int)($e['aprovado']??0); $blob=strtolower(($e['nome']??'').' '.($e['especialidade']??'').' '.($e['endereco_base']??'')); ?>
