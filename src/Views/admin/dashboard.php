...
$statusLabels = [
    ...
    'concluido' => html_entity_decode('Conclu&iacute;do', ENT_QUOTES, 'UTF-8'),
    'cancelado' => 'Cancelado',
];
...
<div class="ops-topbar admin-dashboard-topbar">
    ...
    <div class="ops-topbar__meta">
        <span class="ops-topbar__status"><span class="ops-topbar__status-dot"></span>Opera&ccedil;&atilde;o normal</span>
        <a href="<?php echo htmlspecialchars($bp); ?>/admin/central" class="ops-dashboard-link">Abrir Central</a>
        <a href="<?php echo $bp; ?>/admin/configuracoes" class="ops-dashboard-link"><i class="fas fa-gear me-1"></i>Configura&ccedil;&otilde;es</a>
    </div>
</div>
...
<div class="shell-ops shell-ops--no-worklist" id="dashboardShell">
    ...
    <section class="shell-ops-workspace" id="dashboardWorkspace" aria-label="Vis&atilde;o em tempo real da plataforma" style="padding:24px;">

    <header class="page-head mb-4">
        <div>
            <span class="eyebrow">Central operacional</span>
            <h1>Vis&atilde;o em tempo real da plataforma</h1>
    ...
    <div class="lower-grid mb-4">
        <div class="card h-100">
            <div class="card-header"><i class="fas fa-chart-column me-2"></i>Opera&ccedil;&atilde;o por hora
                <small class="text-muted d-block">Pedidos conclu&iacute;dos</small>
            </div>
            <div class="card-body">
        ...
        <div class="card h-100">
            ...
            <div class="card-body">
                <?php if (empty($qaRelease['disponivel'])): ?>
                    <div class="text-muted small">Nenhuma execu??o Playwright registrada ainda. <a href="<?php echo $bp; ?>/admin/simulador">Rodar simulador</a>.</div>
                <?php else: ?>
    ...
    <?php
        ...
        $statusExpansaoLabelDash = ['nao_ativada' => html_entity_decode('N&atilde;o ativada', ENT_QUOTES, 'UTF-8'), 'pedra_morta' => 'Pedra morta', 'pedra_viva' => 'Pedra viva'];
    ...
    <div class="card mb-4" id="territorioMetasCard">
        ...
        <div class="card-body">
            ...
            <div class="row g-3 mb-3">
                ...
                <div class="col-md-7">
                    <label class="form-label" for="territorioCelula">C&eacute;lula/Zona</label>
            ...
            <div class="row g-3">
                <div class="col-xl-5">
                    <div class="border rounded overflow-hidden">
                        ...
                        <div id="territorioMapaSemPoligono" class="text-muted small p-3 d-none">Sem pol&iacute;gono desenhado ainda.</div>
                    </div>
                    <div id="territorioMapaOverlayInfo" class="text-muted small mt-1"></div>
                </div>
                <div class="col-xl-7">
                    <div id="territorioDetalhes"></div>
                    <?php $legendaMetaHint = html_entity_decode('Cor do gr&aacute;fico indica o status em rela&ccedil;&atilde;o &agrave; meta: verde = bateu a meta, azul = superou a meta, amarelo = perto da meta (80%% ou mais), vermelho = abaixo da meta. Passe o mouse sobre o gr&aacute;fico para ver os n&uacute;meros exatos.', ENT_QUOTES, 'UTF-8'); ?>
                    <div class="row g-3">
    ...
    <div class="card mb-4">
        <div class="card-header"><i class="fas fa-clipboard-question me-2"></i>As 7 perguntas do marketing
            <small class="text-muted d-block">M&ecirc;s atual (<?php echo date('d/m', strtotime($inicioMes)); ?>-<?php echo date('d/m/Y'); ?>)</small>
        </div>
        <div class="card-body">
            <div class="row g-3 mb-3">
                ...
                <div class="col-6 col-md-3">
                    <div class="text-muted small">7. Margem l&iacute;quida (comiss&atilde;o - marketing - estornos - taxas)</div>
    ...
    <div class="row g-3 mb-4">
        ...
        <div class="col-lg-5">
            <div class="card h-100">
                <div class="card-header"><i class="fas fa-chart-pie me-2"></i>Distribui&ccedil;&atilde;o de Status</div>
                <div class="card-body">
                    ...
                    <div class="d-grid gap-2 mt-3" data-dashboard-status-list>
                        ...
                        <div class="text-muted small">Sem dados para distribui&ccedil;&atilde;o de status.</div>
                        <?php endif; ?>
                    </div>
                </div>
            </div>
