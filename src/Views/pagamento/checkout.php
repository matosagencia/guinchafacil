        ...
        bricksBuilder.create('payment', 'mp-payment-brick-container', {
            ...
            callbacks: {
                ...
                onError: function (error) {
                    ...
                    var causa = String((error && (error.cause || error.message)) || '').toLowerCase();
                    if (causa.indexOf('no_payment_method_for_provided_bin') !== -1) {
                        mostrarMensagemGlobal('O Mercado Pago não reconheceu este cartão para o ambiente de teste. Confira o cartão de teste, a bandeira e tente novamente.', 'warning');
                    } else {
