...
define('PUSH_VAPID_PUBLIC_KEY', env('PUSH_VAPID_PUBLIC_KEY', ''));
define('PUSH_VAPID_PRIVATE_KEY', env('PUSH_VAPID_PRIVATE_KEY', ''));
define('PUSH_VAPID_SUBJECT', env('PUSH_VAPID_SUBJECT', APP_URL));
